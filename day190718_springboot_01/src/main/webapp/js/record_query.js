...
function toAnother(id) {
    ...
    if(!!window.ActiveXObject || "ActiveXObject" in window){
        ...
        layer.open({
            ...
            fixed: false, //不固定
            maxmin: true,
            content: '/record_display_word1?scid='+id
        });
    }else {
        window.location.href="javascript:POBrowser.openWindowModeless('/record_display_word1?scid="+id+"','width=1200px;height=800px;');";
    }
